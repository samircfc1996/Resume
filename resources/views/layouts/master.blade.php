...
<header>
    ...
    <nav class="collapsible-nav" id="collapsible-nav">
        ...
        <a href="/resume" class="nav-link    {{ request()->routeIs('resume')?"active":"" }}">RESUME</a>
        <a href="/portfolio" class="nav-link {{ request()->routeIs('portfolio')?"active":"" }}">PORTFOLIO</a>
        <a href="/blog" class="nav-link     {{ request()->routeIs('blog')?"active":"" }}">BLOG</a>
